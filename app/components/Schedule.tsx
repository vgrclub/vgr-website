...
const Schedule = () => {
  return (
    <div className="hero-content bg-primary min-w-full flex flex-col justify-center items-center">
      <div className=''>
      ...
      <div className="flex  w-full justify-center mt-10">
        <div className="w-full sm:w-auto flex flex-wrap justify-center gap-4">
          <div className="grid w-64 card bg-base-300 rounded-box place-items-center m-2">
            <h3 className="text-lg">Wednesdays</h3>
            <p className="text-lg">5:30pm</p>
          </div>
          {/* <div className="divider divider-horizontal"></div> */}
          <div className="grid w-64 card bg-base-300 rounded-box place-items-center m-2">
            <h3 className="text-lg">Saturdays</h3>
